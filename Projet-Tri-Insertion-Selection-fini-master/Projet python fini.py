...
def activate_selection(tab): #Active la fonction tri selection
    ...
    for i in range(0,5): # Pour i entre 0 et 5
        a = input("Entrez vos notes du bac : ") # Sa renvoi ntrez vos notes du bac 
    ...
    print("Vos notes du bac sont maitenant triées:") # Sa affiche que Vos notes du bac sont maitenant triées
    for i in range(len(tab)): # # i est égal à la longueur du tableau / pour i de 0 à 5 (la longueur du tableau)
        print ("%d" %tab[i])
...
def activate_insertion(tab): #Active la fonction tri insertion
    ...
    print ("Vos notes du bac sont maitenant triées:") # Sa affiche que les notes sont triées 
